...
class V4HistoricalSportsSportEventsEventIdOddsGet200ResponseDataBookmakersInnerMarketsInner(BaseModel):
    """
    V4HistoricalSportsSportEventsEventIdOddsGet200ResponseDataBookmakersInnerMarketsInner
    """ # noqa: E501
    key: Optional[StrictStr] = Field(default=None, description="The unique key for the odds market")
    last_update: Optional[datetime] = Field(default=None, description="A timestamp of when the markets's odds were last read. Will be an integer if dateFormat=unix, otherwise it will be a string.")
    outcomes: Optional[List[Outcome]] = None
    __properties: ClassVar[List[str]] = ["key", "last_update", "outcomes"]
