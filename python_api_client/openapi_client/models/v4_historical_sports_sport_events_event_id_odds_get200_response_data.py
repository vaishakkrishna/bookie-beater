...
class V4HistoricalSportsSportEventsEventIdOddsGet200ResponseData(BaseModel):
    """
    ...
    bookmakers: Optional[List[V4HistoricalSportsSportEventsEventIdOddsGet200ResponseDataBookmakersInner]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "bookmakers": [V4HistoricalSportsSportEventsEventIdOddsGet200ResponseDataBookmakersInner.from_dict(_item) for _item in obj["bookmakers"]] if obj.get("bookmakers") is not None else None
        })
        return _obj
