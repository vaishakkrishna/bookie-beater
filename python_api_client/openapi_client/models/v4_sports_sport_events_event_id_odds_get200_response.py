...
class V4SportsSportEventsEventIdOddsGet200Response(BaseModel):
    """
    ...
    bookmakers: Optional[List[V4SportsSportEventsEventIdOddsGet200ResponseBookmakersInner]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "bookmakers": [V4SportsSportEventsEventIdOddsGet200ResponseBookmakersInner.from_dict(_item) for _item in obj["bookmakers"]] if obj.get("bookmakers") is not None else None
        })
        return _obj
