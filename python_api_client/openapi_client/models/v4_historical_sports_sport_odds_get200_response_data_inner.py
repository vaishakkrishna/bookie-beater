...
class V4HistoricalSportsSportOddsGet200ResponseDataInner(BaseModel):
    """
    ...
    bookmakers: Optional[List[V4HistoricalSportsSportOddsGet200ResponseDataInnerBookmakersInner]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "bookmakers": [V4HistoricalSportsSportOddsGet200ResponseDataInnerBookmakersInner.from_dict(_item) for _item in obj["bookmakers"]] if obj.get("bookmakers") is not None else None
        })
        return _obj
